...
export const fetchMonthlyGstReport = (month) =>
  api.get('/reports/monthly-gst', { params: { month } }).then((r) => r.data);
...
export const downloadMonthlyGstXlsx = (month) =>
  api.get('/reports/monthly-gst/export', { params: { month }, responseType: 'blob' })
     .then((r) => r.data);
